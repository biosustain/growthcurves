...
[https://github.com/biosustain/growthcurves](https://github.com/biosustain/growthcurves)
...
the subdirectories of the [`src`](src) directory. The (e.g. `src/growthcurves`).
...
[`src/growthcurves`](src/growthcurves) directory.
...
```toml
[project.urls]
"Bug Tracker" = "https://github.com/biosustain/growthcurves/issues"
"Homepage" = "https://github.com/biosustain/growthcurves"
```
...
[project.scripts]
python-package-hello = "growthcurves.cli:main"
```
...
in the same project under the `growthcurves` package (see example
[here](https://setuptools.pypa.io/en/latest/userguide/package_discovery.html#src-layout)).

```bash
├── src
│   └── growthcurves
│       ├── __init__.py # imported when the package is imported (import growthcurves)
│       └── mockup.py # a submodule of the package (import growthcurves.mockup)
```

So you will need to rename the `growthcurves` directory to your package name,
...
project = "growthcurves"
copyright = "2025, First Last"
author = "First Last"
PACKAGE_VERSION = metadata.version("growthcurves")

# ...

# and again links to your project repository
html_theme_options = {
    "github_url": "https://github.com/biosustain/growthcurves",
    "repository_url": "https://github.com/biosustain/growthcurves",
    # more...
}
...
if os.environ.get("READTHEDOCS") == "True":
    ...
    PACKAGE_ROOT = PROJECT_ROOT / "src" / "growthcurves"
```
...
sphinx-apidoc --force --implicit-namespaces --module-first -o reference ../src/growthcurves
sphinx-build -n -W --keep-going -b html ./ ./_build/
```

this will create a `reference` directory with the API documentation of the Python package
`growthcurves`, a `jupyter_execute` for the tutorial in [`docs/tutorial`](docs/tutorial)
